...
<html lang="ja">
	...
	<head>
		...
		<!-- 自作css -->
		<link rel="stylesheet" href="{{ asset('back/css/back_information.css') }}">  
	...
	<body>
                            ...
                            <div class="row">
                                <div class="col-12 col-md-12 col-lg-12 mb-2">
                                    <div class="info_title mt-3">
                                        <i class="far fa-gem icon_blue me-2"></i>新着情報一覧
                                    </div>
                                    <!-- 境界線 -->
                                    <hr>
                                </div>
		...
		<!-- 自作js -->
		<script src="{{ asset('back/js/back_information.js') }}"></script>
	</body>
